...
That happened. Both packs carry a regression test
...
The Python pack once named three files in `schema.py` while Go read the directory. A fourth schema was added, Go
